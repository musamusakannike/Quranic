...
const testimonials = [
  {
    ...
    tone: "primary",
    quote:
      "The most beautiful Quran app I've ever used. The typography alone is breathtaking.",
  },
  {
    name: "Sara Malik",
    location: "Dubai, UAE",
    ...
    tone: "secondary",
    quote:
      "Quranic has completely transformed my daily routine. SubhanAllah, the design is incredible.",
  },
  {
    name: "Ibrahim Khan",
    location: "Toronto, CA",
    ...
    tone: "tertiary",
    quote:
      "Finally an Islamic app that isn't cluttered with ads or poor design. Editorial quality.",
  },
  {
    name: "Amina Hassan",
    location: "Cairo, EG",
    ...
    tone: "primary",
    quote:
      "The Adhkar reminders are so gentle and timely. It has become a core part of my day.",
  },
  {
    name: "Omar Faruk",
    ...
    tone: "secondary",
    quote:
      "Word-by-word translation changed how I connect with the Quran. Absolutely magnificent.",
  },
  {
    ...
    tone: "tertiary",
    quote:
      "The prayer times are always accurate and the Adhan sound is mesmerising. 5 stars.",
  },
];
...
function TestimonialCard({ t }: { t: (typeof testimonials)[0] }) {
  return (
    <div className="flex-shrink-0 w-80 bg-surface-container-lowest border border-outline-variant/15 rounded-2xl p-6 mx-3 shadow-sm">
      ...
      <p className="text-on-surface-variant text-sm italic leading-relaxed mb-5">
        "{t.quote}"
      </p>
      <div className="flex items-center gap-3">
        <div
          className={`w-10 h-10 rounded-full flex items-center justify-center text-xs font-bold ${toneClasses[t.tone]}`}
        >
          {t.initials}
        </div>
        <div>
...
const deepDiveFeatures = [
  {
    ...
    desc: "Personalize your journey by adding notes and reflections to any Ayah. Your spiritual growth, documented and cherished.",
  },
  {
    icon: "podcasts",
    title: "Guided Podcasts & Tafsir",
    desc: "Listen to exclusive tafsir and spiritual discussions from leading scholars while you commute or rest.",
  },
  {
    icon: "calendar_month",
    title: "Hijri Calendar",
    desc: "Never miss an important Islamic date. Integrated Hijri dates with events, fasting reminders and moon phases.",
  },
];
...
export default function Home() {
  ...
  return (
    <div className="bg-surface font-body text-on-surface selection:bg-primary-fixed selection:text-on-primary-fixed overflow-x-hidden">
      {/* ── Navigation ── */}
      <header
        className={`fixed top-0 w-full z-50 transition-all duration-500 ${isScrolled ? "bg-surface/75 backdrop-blur-2xl shadow-sm border-b border-outline-variant/10 py-3" : "bg-transparent py-5"}`}
      >
      ...
      <main>
        ...
        >
          ...
          <motion.div
            ...
            className="max-w-7xl mx-auto px-6 md:px-10 w-full grid md:grid-cols-12 gap-12 items-center pt-32 pb-20"
          >
            {/* Left: Copy */}
            <motion.div
              initial="hidden"
            ...
            >
              ...
              <motion.h1
                variants={fadeInUp}
                className="font-headline text-[clamp(3rem,7vw,6rem)] text-on-surface font-semibold leading-[1.05] mb-6 tracking-tight"
              >
                Your{" "}
              ...
              >
                ...
                companion. Beautifully crafted for the modern Muslim.
              </motion.p>
              ...
              >
                <div className="flex -space-x-3">
                  {["YA", "SM", "IK", "AH"].map((initials, i) => (
                    <div
                      key={i}
                      className={`w-9 h-9 rounded-full border-2 border-surface flex items-center justify-center text-xs font-bold ${["bg-primary-container text-on-primary-container", "bg-secondary-container text-on-secondary-container", "bg-tertiary-container text-on-tertiary-container", "bg-surface-container-high text-on-surface"][i]}`}
                    >
                      {initials}
                    </div>
                  ))}
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-lg font-headline font-bold text-primary leading-none">
                    5:24 AM
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <p className="text-xs font-medium text-on-surface leading-snug">
                  "The most beautiful Quran app I've ever used."
                </p>
              </motion.div>
            </motion.div>
          </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            ...
            >
              ...
              <h2 className="font-headline text-4xl md:text-5xl lg:text-6xl text-on-surface mb-5 leading-tight">
                A Sanctuary in{" "}
                <span className="italic text-primary">Your Pocket.</span>
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-4 md:h-[640px]">
              ...
              >
                <div className="p-8 flex-1">
                  ...
                  <h3 className="font-headline text-3xl text-on-surface mb-3 leading-tight">
                    Divine Recitation
                  </h3>
                  <p className="text-on-surface-variant text-base leading-relaxed">
                    Experience the Quran with word-by-word translations,
                    transliteration, and crystal clear tajweed rules beautifully
                    rendered.
                  </p>
                </div>
              ...
              >
                ...
                <div className="z-10 relative">
                  ...
                  <h3 className="font-headline text-xl text-on-primary font-semibold mb-2">
                    Immersive Audio
                  </h3>
                  <p className="text-on-primary/75 text-sm leading-relaxed">
              ...
              >
                ...
                <div className="z-10 relative">
                  ...
                  <h3 className="font-headline text-xl text-on-surface font-semibold mb-2">
                    Prayer Times
                  </h3>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-on-surface-variant text-sm leading-relaxed">
                    Precision compass to guide your devotion anywhere on earth.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="z-10 relative">
                  ...
                  <h3 className="font-headline text-xl text-on-secondary-container font-semibold mb-2">
                    Hisnul Muslim
                  </h3>
                  <p className="text-on-secondary-container/75 text-sm leading-relaxed">
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10">
            <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-center">
              ...
              >
                ...
                <motion.h2
                  variants={fadeInUp}
                  className="font-headline text-4xl md:text-5xl lg:text-6xl text-on-surface leading-tight mb-6"
                >
                ...
                >
                  Quranic isn't just an app — it's a companion for your
                  spiritual life. Every feature is designed to help you build
                  habits that last.
                </motion.p>
                ...
                <div className="space-y-8">
                  {deepDiveFeatures.map((item, idx) => (
                    ...
                    >
                      ...
                      <div>
                        <h3 className="text-lg font-bold mb-1.5 text-on-surface">
                          {item.title}
                        </h3>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10">
            ...
            >
              <h2 className="font-headline text-5xl md:text-7xl text-inverse-on-surface mb-6 leading-tight">
                Designed for{" "}
                <span className="italic text-primary-fixed-dim">Focus.</span>
              </h2>
            ...
            <div className="relative flex justify-center items-end gap-4 md:gap-8 h-[480px] md:h-[600px]">
              ...
              >
                <img
                  alt="App Homepage"
                  className="rounded-[2rem] shadow-2xl border-4 border-white/10 w-full"
                  src="/images/mobile-homepage.PNG"
                />
              </motion.div>
              ...
              >
                <img
                  alt="App Chapter Details"
                  className="rounded-[2.5rem] shadow-[0_50px_120px_rgba(0,0,0,0.6)] ring-8 ring-primary/20 w-full"
                  src="/images/mobile-chapter-details.PNG"
                />
              </motion.div>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-10 mb-12">
            ...
            >
              ...
              <h2 className="font-headline text-4xl md:text-5xl text-on-surface">
                Loved by the <span className="italic text-primary">Ummah.</span>
              </h2>
            </motion.div>
          </div>
        ...
        <section className="py-24 overflow-hidden">
          <div className="max-w-5xl mx-auto px-6 md:px-10">
            <motion.div
              ...
              style={{
                background:
                  "linear-gradient(135deg, var(--color-primary) 0%, var(--color-primary-container) 60%, var(--color-secondary) 100%)",
              }}
            >
              {/* Background patterns */}
              ...
              <div className="relative z-10">
                ...
                >
                  ...
                  spiritual practice with Quranic. Free forever.
                </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-10">
          <div className="grid md:grid-cols-4 gap-10 mb-12">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-headline italic text-primary font-semibold">
                  Quranic
                </span>
              </div>
              <p className="text-on-surface-variant text-sm leading-relaxed max-w-xs">
                A beautiful Islamic companion app for the modern Muslim. Recite,
                listen, reflect.
              </p>
            </div>
            {/* Links */}
            <div>
              <p className="text-xs font-bold uppercase tracking-widest text-on-surface mb-4">
                Product
              </p>
          ...
          <div className="pt-8 border-t border-outline-variant/10 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-on-surface-variant">
              © 2025 Quranic. The Sacred Breath.
            </p>
            <p className="text-xs text-on-surface-variant/60 font-arabic">
