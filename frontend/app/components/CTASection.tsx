...
export default function CTASection() {
  ...
  return (
    <section className="relative py-28 sm:py-36 bg-ink overflow-hidden">
      ...
      <div ref={ref} className="relative z-10 mx-auto max-w-3xl px-5 sm:px-8 text-center">
        <motion.div
        ...
        >
          ...
          <h2 className="font-headline text-[clamp(2rem,4.5vw,3.2rem)] font-semibold text-parchment tracking-tight mb-5 leading-tight">
            Begin your journey today
          </h2>

          <p className="text-[16px] leading-relaxed text-slate-300 max-w-lg mx-auto mb-10">
            Download Quranic for free and discover a spiritual companion designed
            with beauty, purpose, and care. Available on both iOS and Android.
          </p>
