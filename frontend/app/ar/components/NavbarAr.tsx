        ...
        <div className="mx-auto max-w-7xl px-5 sm:px-8 flex items-center justify-between h-[72px]">
          ...
          <div className="hidden md:flex items-center gap-1">
            {navLinks.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="px-4 py-2 text-[15px] font-arabic text-slate-300 hover:text-parchment transition-colors duration-200 rounded-lg hover:bg-surface-glass"
              >
                {link.label}
              </a>
            ))}
          ...
          <div className="hidden md:flex items-center gap-3">
            <a
              ...
              className="px-5 py-2.5 text-[14px] font-medium font-arabic text-ink bg-parchment rounded-xl hover:bg-parchment-warm transition-all duration-300 hover:shadow-lg hover:shadow-teal/10 hover:-translate-y-0.5 active:translate-y-0"
            >
              حمّل مجاناً
            </a>
          </div>
            ...
            <div className="flex flex-col gap-2">
              {navLinks.map((link, i) => (
                <motion.a
                  ...
                  className="py-4 px-4 text-lg text-parchment border-b border-border-subtle font-arabic text-right"
                >
                  {link.label}
                </motion.a>
              ))}
              <motion.a
                ...
                className="mt-6 py-4 text-center text-ink bg-parchment rounded-2xl font-arabic font-medium text-lg"
              >
                حمّل مجاناً
              </motion.a>
            </div>
