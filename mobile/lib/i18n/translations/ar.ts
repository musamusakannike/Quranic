const ar = {
  ...
  hijriCalendar: {
    ...
    noEventsThisMonth: "لا توجد مناسبات خاصة هذا الشهر",
    ...
    events: {
      ...
      shaabanMiddle: "ليلة النصف من شعبان",
      ramadanStart: "بداية رمضان",
      laylatAlQadr: "ليلة القدر (٢٧)",
      eidAlFitr: "عيد الفطر",
  ...
  chapter: {
    ...
    goBack: "رجوع",
    chapters: "السور",
    searchPlaceholder: "ابحث في آيات هذه السورة",
    verses_one: "{{count}} آية",
    verses_other: "{{count}} آيات",
    ...
    modeMushaf: "مصحف",
    showTranslations: "إظهار الترجمة",
    showTranslationsDesc: "الترجمة الإنجليزية تحت الآية",
    showTransliterations: "إظهار النطق",
    showTransliterationsDesc: "النطق اللاتيني تحت الآية",
    arabicTextSize: "حجم النص العربي",
    translationTextSize: "حجم نص الترجمة",
    done: "تم",
    sajda: "سجدة",
    ...
    previous: "السابق",
    next: "التالي",
    noVersesFound: "لا توجد آيات.",
    copiedTitle: "تم النسخ",
    copiedMsg: "تم نسخ الآية {{verse}} إلى الحافظة.",
    pageDisplay: "صفحة {{page}}",
    nowPlaying: "يُشغَّل الآن",
    readAlong: "القراءة المتزامنة",
  ...
  hifzExtra: {
    ...
    hideReveal: "إخفاء وكشف",
    memorized: "محفوظ",
    learning: "قيد الحفظ",
    overallProgress: "التقدم الإجمالي",
    bySurah: "حسب السورة",
    noHifzTitle: "لم يبدأ الحفظ بعد",
    noHifzSubtitle: "استخدم تبويب الإخفاء والكشف لتحديد الآيات المحفوظة",
    memorizedVerses: "الآيات المحفوظة",
    learningVerses: "الآيات قيد الحفظ",
    howTracked: "كيف يتم تتبع تقدمك",
    gotIt: "فهمت",
    resetTitle: "إعادة تعيين {{name}}",
    resetMsg: "سيؤدي هذا إلى مسح جميع بيانات الحفظ لهذه السورة. هل أنت متأكد؟",
    reset: "إعادة تعيين",
    cancel: "إلغاء",
    ofQuran: "٪ من القرآن",
    totalLabel: "إجمالي",
    memorizedLabel: "محفوظ",
    learningLabel: "قيد الحفظ",
  },

  // ── Audio screens ─────────────────────────────────────────────────────────
  audio: {
    browseReciters: "تصفح القراء",
    reciters: "القراء",
    chapterReciters: "قراء السور",
    verseByVerse: "آية بآية",
    searchReciters: "ابحث عن قارئ...",
    recitersFound_one: "{{count}} قارئ",
    recitersFound_other: "{{count}} قراء",
    selectSurah: "اختر سورة للاستماع إلى هذا القارئ.",
    selectSurahVerse: "اختر سورة للاستماع آية بآية مع القراءة المتزامنة.",
    searchSurahs: "ابحث عن سورة...",
    surahsFound_one: "{{count}} سورة",
    surahsFound_other: "{{count}} سور",
    playNext: "تشغيل التالي",
    filters: "الفلاتر",
    filtersReset: "إعادة تعيين",
    riwayat: "الروايات",
    moshaf: "المصحف (الأسلوب)",
    all: "الكل",
    murattal: "مرتل",
    mujawwad: "مجوّد",
    teaching: "تعليمي",
    verseByVerseLabel: "تلاوة آية بآية",
    nowPlaying: "يُشغَّل الآن",
    readAlong: "القراءة المتزامنة",
    upNext: "التالي",
    queueEmpty: "قائمة التشغيل فارغة",
