...
export default function ShareVerseModal({
  ...
  const handleCopy = async () => {
    const shareText = `${verse.text}\n\n${verse.translation || ""}\n\n- Surah ${verse.chapterName}, Ayah ${verse.verseNumber}\nShared via Quranic App`;
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Copy size={20} color="#FFFFFF" style={{ marginRight: 8 }} />
          <Text style={styles.shareButtonText}>Copy Ayah Text</Text>
        </Pressable>
      </View>
    </Modal>
  );
